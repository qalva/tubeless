...
### Opening the Menu
*   **The Popup**: Click the Tubeless icon in your browser toolbar for quick toggles and speed controls.
*   **The Dashboard**: Click the "Settings" icon (gear) in the popup or press the `O` key to open the full dashboard.
...
> [!IMPORTANT]
> To enable downloads, ensure you have the <a href="https://www.mediafire.com/file/vi8tolbhgvq2974/TubelessSetup-1.0.1.exe/file" target="_blank">Tubeless Desktop</a> running on your PC.

### How to Download
1.  Open any YouTube video.
2.  Click the **Download** button in the popup.
...
2.  Click **Change** next to a hotkey.
3.  Press any key on your keyboard to bind it.
4.  Click **Reset** if you want to go back to the factory default.
