...
var LOADING_EVENT_NAME = 'wait-aby-status';
var SEND_EVENT_NAME = 'send-aby-status';

;
var custom_massage_listener_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var custom_massage_listener_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
    return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var extensionStatusMessageListener = function () { return custom_massage_listener_awaiter(void 0, void 0, void 0, function () {
    ...
    return custom_massage_listener_generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                createEvent = function () { return custom_massage_listener_awaiter(void 0, void 0, void 0, function () {
                    var isEnabled;
                    return custom_massage_listener_generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, getFromChromeStorage(SettingsKeys.Ads)];
                            case 1:
                                isEnabled = _a.sent();
                                return [2, new CustomEvent(LOADING_EVENT_NAME, {
                                        detail: { isEnabled: !!isEnabled },
                                    })];
                        }
                    });
                }); };
                eventHandler = function () { return custom_massage_listener_awaiter(void 0, void 0, void 0, function () {
                    var _a, _b;
                    return custom_massage_listener_generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                _b = (_a = window).dispatchEvent;
                                return [4, createEvent()];
                            case 1:
                                _b.apply(_a, [_c.sent()]);
                                return [2];
                        }
            ...
            case 1:
                _b.apply(_a, [_c.sent()]);
                window.addEventListener(SEND_EVENT_NAME, eventHandler);
                return [2];
        }
    });
}); };
...
var POPUPS_MAP = (popups_map_a = {},
    popups_map_a[PopupTypesEnum.Windows] = {
    ...
    popups_map_a[PopupTypesEnum.Mobile] = {
    ...
    popups_map_a[PopupTypesEnum.AntiAdblock] = {
    ...
    popups_map_a[PopupTypesEnum.RateUs] = {
        html: rateUsHtml,
        css: rateUsPopupCss,
...
var handlePopupClose = function (dialog, storageKeyRestriction) { return add_listeners_awaiter(void 0, void 0, void 0, function () {
    ...
    return add_listeners_generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Failed to save popup restriction', error_1);
                return [3, 5];
            case 4:
                dialog.remove();
                return [7];
    ...
    return content_script_generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, extensionStatusMessageListener()];
            case 2:
                _a.sent();
                return [4, toggleExtensionMassageListener()];
            case 3:
                _a.sent();
                if (!ads)
                    return [2];
