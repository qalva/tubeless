...
const UI_TEXT = {
  en: {
    ...
    sectionMedia: 'Shortcuts & Capture',
  ...
  ar: {
    ...
    sectionProductivity: 'الإنتاجية والمحتوى',
    sectionPlayer: 'المشغل',
    sectionDownloads: 'التحميلات',
    sectionMedia: 'الاختصارات والالتقاط',
  ...
  fr: {
    ...
    sectionMedia: 'Raccourcis & Capture',
  ...
  de: {
    ...
    sectionPlayer: 'Player',
    sectionDownloads: 'Downloads',
    sectionMedia: 'Tastenkürzel & Erfassung',
  ...
  es: {
    ...
    quickAccess: 'Usado recientemente',
    upToDate: 'Al día',
  ...
  ja: {
    ...
    sectionPlayer: 'プレイヤー',
    sectionDownloads: 'ダウンロード',
    sectionMedia: 'ショートカットとキャプチャ',
  ...
  pt: {
    ...
    navDislikes: 'Não gostei',
    navProductivity: 'Produtividade',
    navPlayer: 'Reprodutor',
    navDownloads: 'Downloads',
    navMedia: 'Atalhos',
    ...
    sectionPlayer: 'Player',
    sectionDownloads: 'Downloads',
    sectionMedia: 'Atalhos e Captura',
    ...
    thumbnails: 'Miniatura',
    quickAccess: 'Usado recentemente',
    upToDate: 'Atualizado',
  ...
  ru: {
    ...
    sectionPlayer: 'Плеер',
    sectionDownloads: 'Загрузки',
    sectionMedia: 'Горячие клавиши и захват',
    ...
    quickAccess: 'Недавно использованные',
    upToDate: 'Актуально',
  ...
  ko: {
    ...
    sectionPlayer: '플레이어',
    sectionDownloads: '다운로드',
    sectionMedia: '단축키 및 캡처',
  ...
  tr: {
    ...
    sectionMedia: 'Kısayollar & Yakalama',
  ...
  hi: {
    ...
    sectionDownloads: 'डाउनलोड',
    sectionMedia: 'शॉर्टकट्स और कैप्चर',
    ...
    thumbnails: 'थंबनेल',
    quickAccess: 'हाल ही में उपयोग किया गया',
    upToDate: 'अप टू डेट',
...
async function incrementSettingStat(key) {
  const candidates = [
    ...
    'hideHomeFeed', 'forceCinemaMode', 'autoReplayVideos', 'autoReplayShorts',
      ...
      const tooltipKey = key === 'deepWorkMode' ? 'deepWork' :
        (key === 'forceCinemaMode' ? 'cinemaMode' :
          (key === 'autoReplayVideos' ? 'loopVideos' :
            (key === 'autoReplayShorts' ? 'loopShorts' : key)));
