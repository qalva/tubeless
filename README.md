...
1. Download the <a href="https://github.com/qalva/tubeless/releases/latest" target="_blank" rel="noopener noreferrer">Tubeless Extension</a> from the Releases page, scroll to the bottom of the latest release, then click the `.zip` file in the **Assets** section to download it.
...
8. Pin the extension to the toolbar for quick access.
